        ...
        <div className="flex-1 min-w-0">
          ...
          {visit.rating !== undefined && (
            <div className="shrink-0 flex items-center gap-[4px]">
              <Star size={13} fill="#fcd413" className="text-[#fcd413]" />
              <span className="text-[13px] font-semibold text-white leading-none" style={{ fontFamily: "Poppins, sans-serif" }}>
                {visit.rating.toFixed(1).replace(".", ",")}
              </span>
            </div>
          )}
          </div>
